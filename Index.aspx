                            ...
                            <div class="navbar-header">
                                ...
                                <div class="logo wow slideInLeft" data-wow-delay="0.3s">
                                    <a class="" href="index.html">
                                        <img src="images/Copy of aoplogo1.png" /></a>
                                </div>
                            </div>
            ...
            <div class="slider-wrapper theme-default">
                <div id="slider" class="nivoSlider">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AOPConnectionString %>"
                        SelectCommand="SELECT [Id], [SliderImage],[ImageName] FROM [Slider]"></asp:SqlDataSource>
                    <asp:Repeater ID="RptSlider" runat="server" DataSourceID="SqlDataSource1" OnItemDataBound="RptSlider_ItemDataBound">
                        <ItemTemplate>
                            ...
                            <img src="<%#"NivoSlider/demo/images/"+Eval("ImageName") %>" data-thumb="<%#"NivoSlider/demo/images/"+Eval("ImageName") %>" alt="" />
        ...
        <div class="about" id="About">
            <div class="container">
                <div class="about-main">
                    ...
                    <div class="col-md-9 about-right">
                        <div class="about-top">
                            ...
                            <ul>
                                <li>
                                    <p>I remember thinking, as a child, it was taking forever to grow up. I counted each milestone – teen years, learner’s permit, license and finally, adulthood.</p>
                                </li>
                                <li>
                                    <p>I finally grew up. I met my husband, and we had our own children. And now, as a parent, I can’t believe how fast time is going.</p>
                                </li>
                            </ul>
               ...
               <asp:Image ID="imgTeam" runat="server" />
                            ...
                            <asp:SqlDataSource ID="SqlDataSourceTeam" runat="server" ConnectionString="<%$ ConnectionStrings:AOPConnectionString %>"
                                SelectCommand="SELECT ID, ProfilePic FROM Team_DE"></asp:SqlDataSource>
                            <asp:Repeater ID="RptTeam" runat="server" DataSourceID="SqlDataSourceTeam" OnItemDataBound="RptTeam_ItemDataBound">
                                <ItemTemplate>
                                    <div class="col-md-4 team-grid">
                                        <%--<asp:Image ID="imgTeam" runat="server" />--%>
                                        <%--<img src alt="" width="" height="" />--%>
                                        <asp:HiddenField Value='<%# Eval("id") %>' ID="HiddenFieldTeamid" runat="server" />
                                        <asp:Image ID="imgTeam" runat="server" />
                                        <%--<asp:Image ID="imgTeam" runat="server" ImageUrl=""~/ShowImage.ashx?id=" + <%#Eval("ID") %>""/>--%>
                                    </div>
                                </ItemTemplate>
                    ...
                    <div id="portfoliolist">
                        <div class="col-md-3 portfolio-wrapper">
                            <a href="images/b-p1.jpg" class="b-link-stripe b-animate-go  swipebox" title="Image Title">
                                <img src="images/p1.jpg" alt=""><div class="b-wrapper">
                                    <h2 class="b-animate b-from-left    b-delay03">
                                        <img src="images/plus.png" alt="" /></h2>
                                </div>
                            </a>
                        </div>
                        <div class="col-md-3 portfolio-wrapper">
                            <a href="images/b-p3.jpg" class="b-link-stripe b-animate-go  swipebox" title="Image Title">
                                <img src="images/p3.jpg" alt=""><div class="b-wrapper">
                                    <h2 class="b-animate b-from-left    b-delay03">
                                        <img src="images/plus.png" alt="" /></h2>
                                </div>
                            </a>
                        ...
                        <div class="col-md-3 portfolio-wrapper">
                            <a href="images/b-p2.jpg" class="b-link-stripe b-animate-go  swipebox" title="Image Title">
                                <img src="images/p2.jpg" alt=""><div class="b-wrapper">
                                    <h2 class="b-animate b-from-left    b-delay03">
                                        <img src="images/plus.png" alt="" /></h2>
                                </div>
                            </a>
                        ...
                        <div class="col-md-3 portfolio-wrapper">
                            <a href="images/b-p4.jpg" class="b-link-stripe b-animate-go  swipebox" title="Image Title">
                                <img src="images/p4.jpg" alt=""><div class="b-wrapper">
                                    <h2 class="b-animate b-from-left    b-delay03">
                                        <img src="images/plus.png" alt="" /></h2>
                                </div>
                            </a>
                        ...
                        <div class="col-md-3 portfolio-wrapper">
                            <a href="images/b-p5.jpg" class="b-link-stripe b-animate-go  swipebox" title="Image Title">
                                <img src="images/p5.jpg" alt=""><div class="b-wrapper">
                                    <h2 class="b-animate b-from-left    b-delay03">
                                        <img src="images/plus.png" alt="" /></h2>
                                </div>
                            </a>
                        ...
                        <div class="col-md-3 portfolio-wrapper">
                            <a href="images/b-p6.jpg" class="b-link-stripe b-animate-go  swipebox" title="Image Title">
                                <img src="images/p6.jpg" alt=""><div class="b-wrapper">
                                    <h2 class="b-animate b-from-left    b-delay03">
                                        <img src="images/plus.png" alt="" /></h2>
                                </div>
                            </a>
                        ...
                        <div class="col-md-3 portfolio-wrapper">
                            <a href="images/b-p7.jpg" class="b-link-stripe b-animate-go  swipebox" title="Image Title">
                                <img src="images/p7.jpg" alt=""><div class="b-wrapper">
                                    <h2 class="b-animate b-from-left    b-delay03">
                                        <img src="images/plus.png" alt="" /></h2>
                                </div>
                            </a>
                        ...
                        <div class="col-md-3 portfolio-wrapper">
                            <a href="images/b-p8.jpg" class="b-link-stripe b-animate-go  swipebox" title="Image Title">
                                <img src="images/p8.jpg" alt=""><div class="b-wrapper">
                                    <h2 class="b-animate b-from-left    b-delay03">
                                        <img src="images/plus.png" alt="" /></h2>
                                </div>
                            </a>
