<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="Admin_Team.aspx.cs" Inherits="Admin_Admin_Team" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="grid-form">
                    <%--<div class="grid-form1">
                        <h3 id="forms-example" class="">Add New Member</h3>
                        <Div>
                    ...
                    <!----->
                    <div class="grid-form1">
                        <h3 id="forms-horizontal">Add New Team Member</h3>
                        <Div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-2 control-label hor-form">First Name</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label hor-form">Date of Birth</label>
                                <div class="col-sm-10">
                                    <%--<input type="email" class="form-control" id="inputEmail3" placeholder="Email">--%>
                                    <asp:Calendar ID="CalendarDOB" DayNameFormat="Shortest" runat="server"></asp:Calendar>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label hor-form">Designation</label>
                                <div class="col-sm-10">
                                    <%--<input type="email" class="form-control" id="inputEmail3" placeholder="Email">--%>
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label hor-form">About</label>
                                <div class="col-sm-10">
                                    <%--<input type="email" class="form-control" id="inputEmail3" placeholder="Email">--%>
                            ...
                            <div class="form-group">
                                <label for="exampleInputFile" class="col-sm-2 control-label hor-form">Profile Picture</label>
                                <div class="col-sm-10">
                                <%--<input type="file" id="exampleInputFile">--%>
                                    <asp:FileUpload ID="FileUploadNewMember" runat="server" />
                                <p class="help-block">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    ...
                                    <asp:Button ID="btnAdd" class="btn btn-default" runat="server" Text="Add Member" OnClick="btnAdd_Click"/>
                                </div>
                            </div>
                        </Div>
                    </div>
                   ...
                   <%-- <div class="grid-form1">
                            ...
                            <div class="tab-pane active" id="horizontal-form">
                                <Div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="txtarea1" id="txtarea1" cols="50" rows="4" class="form-control1"></textarea></div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="form-group has-success">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group input-icon right">
                                            ...
                                            <input id="Text1" class="form-control1" type="text" placeholder="Email Address">
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-icon right spinner">
                                            ...
                                            <input id="Text2" class="form-control1" type="text" placeholder="Processing...">
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                        ...
                        <div class="form-group">
                            <label for="exampleInput2   ">File input</label>
                            <input type="file" id="exampleInputFile">
